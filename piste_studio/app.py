...
def create_app(project_root: Path, ui_path: Path | None = None) -> FastAPI:
    ...
    app = FastAPI(title="PISTE Studio Local App", version="0.14")
    ...
    def ui_asset(filename: str):
        if filename not in {"style.css", "state.js", "editor.js", "ux-browser.js", "ux-timeline.js", "ux-magnetic.js", "ux-shell.js", "backend.js"}:
    ...
    @app.get("/api/health")
    def health():
        return {"ok": True, "version": "0.14", "project_root": str(root)}
