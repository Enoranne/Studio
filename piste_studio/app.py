...
def create_app(project_root: Path, ui_path: Path | None = None) -> FastAPI:
    ...
    def ui_asset(filename: str):
        if filename not in {"style.css", "state.js", "editor.js", "ux-browser.js", "ux-timeline.js", "ux-magnetic.js", "ux-shell.js", "ux-polish.js", "ux-editorial.js", "ux-media-intelligence.js", "ux-editorial-vision.js", "ux-semantic-vision.js", "ux-targeted-references.js", "ux-timeline-continuity.js", "ux-audio-mix.js", "ux-audio-intelligence.js", "ux-audio-delivery.js", "backend.js"}:
