(() => {
  ...
  const universalEntries = [
    ...
    {kind:"action",domain:"editorial",label:"Titre · Ajouter un carton final",hint:"",keywords:"titre final card end slate credits noir fin",summary:"Ajouter un carton spécialisé aligné sur la fin du montage.",run:()=>typeof addFinalCard==="function"&&addFinalCard()},
    ...
    {kind:"action",domain:"editorial",label:"Vision · Continuité voisins",hint:"",keywords:"timeline previous next voisin continuity rupture candidate raccord",summary:"Analyser le plan précédent, le candidat et le plan suivant.",run:()=>typeof openTimelineContinuity==="function"&&openTimelineContinuity()},
    ...
    {kind:"action",domain:"delivery",label:"Delivery · Festival / social",hint:"Export",keywords:"delivery export festival social vertical square prores youtube preset",summary:"Ouvrir les profils de livraison festival et réseaux sociaux.",run:()=>typeof openDeliveryCenter==="function"&&openDeliveryCenter()},
